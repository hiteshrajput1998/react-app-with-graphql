...
function MapScreen(props) {
    ...
    return (
        <div style={{ backgroundColor: 'gray', display: 'flex', justifyContent: 'center', alignItems: 'center', marginTop: '5%', marginLeft: '15%' }}>
            {
                cordinates?.latitude !== null && cordinates?.longitude !== null &&

                <Map center={[cordinates?.latitude, cordinates?.longitude]} zoom={13} style={{ width: '80%', height: '500px' }}>
                    <TileLayer
